...
func _enter_tree() -> void:
	...
	_dock.add_child(_button("Open baked LEVEL (DOS) — geometry only", _open_level.bind(false)))
	_dock.add_child(_button("Open baked LEVEL (ENHANCED) — geometry only", _open_level.bind(true)))
